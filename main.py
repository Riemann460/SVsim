    ...
    for turn_num in range(1, 21):  # 20턴까지 진행 예시
        ...
        while True:
            ...
            if choice == 0:  # 패에서 카드 내기
                ...
                # 사용할 카드 선택
                card_choices = {game.game_state_manager.get_card_name(card_id): card_id for card_id in playable_cards_id}
                ...
                # 필드 카드 출력
                card_choices = {game.game_state_manager.get_card_name(card_id): card_id for card_id in player_field_card_ids}
                card_choices["뒤로 가기"] = None
                ...
                if chosen_action == "추종자 공격":
                    ...
                    # 공격 대상 목록 출력
                    target_choices = {game.game_state_manager.get_card_name(target_id): target_id for target_id in possible_targets_id}
