...
## 1. About The Project
SVsim은 Cygames의 디지털 카드 게임 '섀도우버스: 월즈 비욘드'의 핵심 게임플레이 로직을 구현한 Python 기반 엔진입니다. 본 프로젝트는 카드의 복잡한 상호작용과 게임 규칙을 정확하게 처리하고, 확장에 용이한 아키텍처를 구축하는 것을 목표로 합니다.
...
### 카드 DB 파이프라인
 ...
 - 파싱을 통해 텍스트 기반의 카드 효과를 엔진이 처리 가능한 구조적 데이터로 변환
